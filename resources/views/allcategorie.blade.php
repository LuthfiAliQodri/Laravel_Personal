...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/dtble.css">
  <!-- endinject -->
        ...
        <ul class="navbar-nav navbar-nav-left header-links d-none d-md-flex">
          <li class="nav-item active">
            <a href="#" class="nav-link">
              <i class="mdi mdi-elevation-rise"></i>Project Data/Blog</a>
          </li>
          <!-- <li class="nav-item">
            <a href="#" class="nav-link">
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                <div class="profile-image">
                  <img src="images/faces/3.jpg" alt="profile image">
                </div>
              ...
              <button class="btn btn-success btn-block">{{ Auth::user()->membership }}
              </button>
            </div>
          </li>
          <li class="nav-item">
        ...
        <div class="content-wrapper">
                  ...
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{\App\Categorie::count()}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-alert-octagon mr-1" aria-hidden="true"></i> The number of categories on the web
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{\App\Gallery::count()}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-image-filter" aria-hidden="true"></i> The number of gallery's on the web
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{\App\Blog::count()}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-calendar mr-1" aria-hidden="true"></i> The number of Post's on the web
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-body">
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-account-multiple" aria-hidden="true"></i> These are the people who contributed to this web
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                <a href="/categorie/export_excel" class="btn btn-info my-3" >EXPORT EXCEL</a>
                    ...
                    <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{action('CategorieController@edit', $categorie['id'])}}" class="btn btn-warning">Edit</a>
