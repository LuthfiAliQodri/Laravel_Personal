                ...
                <ul class="navbar-nav navbar-nav-left header-links d-none d-md-flex">
                    <li class="nav-item active">
                        <a href="#" class="nav-link">
                            <i class="mdi mdi-elevation-rise"></i>Reports/Home</a>
                    </li>
                    <!-- <li class="nav-item">
            <a href="#" class="nav-link">
                    ...
                    <div class="row">
                        <div class="col-lg-7 grid-margin stretch-card">
                            ...
                            <div class="card card-weather">
                                <div class="card-body">
                                    <a class="weatherwidget-io" href="https://forecast7.com/en/n6d40106d79/depok/"
                                        data-label_1="DEPOK" data-label_2="WEATHER" data-theme="original">DEPOK
                                        WEATHER</a>
                                    <script>
                                        ! function (d, s, id) {
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="wrapper d-flex justify-content-between">
                                        <div class="side-left">
                                            ...
                                            <p class="display-3 mb-5 font-weight-light">-5.3%</p>
                                        </div>
                                        <div class="side-right">
